...
import { Package, Mail, Lock, AlertCircle, FileText, ShoppingBag, Zap, Shield } from 'lucide-react'
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="hidden md:flex flex-col justify-center text-white animate-fade-in">
            ...
            <p className="text-xl text-primary-100 mb-8">
              Sign in to continue shopping from thousands of products
            </p>
              ...
              <div className="mt-8 space-y-4">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-4 bg-white text-gray-500">New to QuickCommerce?</span>
                  </div>
                </div>
